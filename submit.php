...
if (Token == $_POST['token']) {
  ...
  array_push($namesS, $_POST['name1']);
  array_push($numbersS, $_POST['number1']);
  ...
  if (isset($_POST['name2']) && !empty($_POST['name2'])) {
    if (isset($_POST['number2']) && !empty($_POST['number2'])) {
      array_push($namesS, $_POST['name2']);
      array_push($numbersS, $_POST['number2']);
    }
  }
  if (isset($_POST['name3']) && !empty($_POST['name3'])) {
    if (isset($_POST['number3']) && !empty($_POST['number3'])) {
      array_push($namesS, $_POST['name3']);
      array_push($numbersS, $_POST['number3']);
    }
  }
} else {
      ...
      <div class="group-3">
        ...
        <div class="desc">
          ...
          for ($i = 0; $i < count($namesS); $i++) {
            ...
            <li>
              <div class='msg-1'><br></div>
              <div class='msg-2'>" . ucwords($namesS[$i]) . "</div>
              <div class='msg-3'>" . ucfirst($numbersS[$i]) . "</div>
            </li>
          </ul>";
          }
          ?>
