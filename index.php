    ...
    <div class="container text-light">
        ...
        <div class="form-container">
            <form action="submit.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="border border-dark p-3 mb-3">
                    <h2>REFERENCE (Max:3)</h2>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Name</label>
                        <input type="text" name="name1" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Number | Email</label>
                        <input type="text" name="number1" class="form-control">
                    </div>
                    <div id="addREFFERENCE"></div>
                    <div class="mb-3">
                        <button type="button" id="REFFERENCE_hide" class="btn btn-primary form-control" onclick="addREFFERENCE()">+</button>
                    </div>
                </div>
